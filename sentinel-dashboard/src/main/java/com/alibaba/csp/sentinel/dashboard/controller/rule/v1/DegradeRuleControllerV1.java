...
public class DegradeRuleControllerV1 {

    private final Logger logger = LoggerFactory.getLogger(DegradeRuleControllerV1.class);
    ...
    public Result<List<DegradeRuleEntity>> queryRules(String app, String ip, Integer port) {
